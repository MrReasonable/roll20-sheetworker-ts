...
export interface EventInfo {
  ...
  export declare function on(event: `change:${string}` | `remove:repeating_${string}` | `change:_reporder:${string}` | `clicked:${string}`, callback: (eventInfo: EventInfo) => void): void;
   ...
   */
  export declare function getAttrs<K extends string>(attributes: K[], callback: (values: Record<K, string>) => void): void;
   ...
   */
  export declare function setAttrs(values: Record<string, string | number>, options?: { silent?: boolean }, callback?: () => void): void;
   ...
   */
  export declare function getSectionIDs(section: string, callback: (ids: string[]) => void): void;
   ...
   */
  export declare function setDefaultToken(values: Record<string, string | number | boolean | null>): void;
